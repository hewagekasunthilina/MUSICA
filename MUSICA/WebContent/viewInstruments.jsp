...
<title>View Music Instruments </title>
...
<%
  ...
  <div class="card-body">
    ...
    <a href="updateInstrument.jsp?id=<%=instrument.getId()%>" class="btn btn-primary">Update</a>
    <a href="deleteInstrumentServlet?id=<%=instrument.getId()%>" class="btn btn-danger">Delete</a>
